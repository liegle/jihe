...
impl Write {
    pub fn new(
        ...
        let bind_group = create_bind_group(device, &bind_group_layout, color_texture_view);
    ...
    pub fn remake_bind_group(
        ...
        self.bind_group = create_bind_group(device, &self.bind_group_layout, color_texture_view);
    }
